...
/* $Id: keep.c,v 1.1 1993/08/15 15:56:11 espie Exp espie $
 * $Log: keep.c,v $
 * Revision 1.1  1993/08/15  15:56:11  espie
 * Initial revision
 *
...
LOCAL char *id = "$Id: keep.c,v 1.1 1993/08/15 15:56:11 espie Exp espie $";
